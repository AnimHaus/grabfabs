          ...
          <>
              ...
              {items.map(({ product, sku, quantity }) => (
                <div key={`${product.id}-${sku.label}`} className="flex items-center gap-6 py-6">
                  ...
                  <div className="text-right flex-shrink-0 w-16">
                    <span className="text-dark font-black text-xl" style={{ fontFamily: 'var(--font-anton)' }}>₹{sku.price * quantity}</span>
                  </div>
                  {/* Remove */}
                  <button
            ...
            <div className="mt-8 border-t border-dark/10 pt-8 flex flex-col gap-4">
              <div className="flex justify-between items-center">
                <span className="text-dark/60 tracking-widest uppercase text-sm" style={{ fontFamily: 'var(--font-syne)' }}>Subtotal</span>
                <span className="text-dark font-black text-2xl" style={{ fontFamily: 'var(--font-anton)' }}>₹{subtotal}</span>
              </div>
