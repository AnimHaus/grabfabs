    ...
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="text-center max-w-md px-6">
          ...
          <h2 className="text-green mb-3" style={{ fontFamily: 'var(--font-anton)', fontSize: 'clamp(2rem, 6vw, 4rem)' }}>
            ORDER PLACED!
          </h2>
            ...
            <div key={s} className="flex items-center gap-3">
              <div
                className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-black transition-colors ${
                  isActive ? 'bg-green text-cream' : isDone ? 'bg-amber text-cream' : 'bg-dark/10 text-dark/40'
                }`}
                style={{ fontFamily: 'var(--font-syne)' }}
              >
                {isDone ? '✓' : i + 1}
              ...
              <span
                className={`text-xs tracking-widest uppercase font-bold ${isActive ? 'text-green' : 'text-dark/40'}`}
                style={{ fontFamily: 'var(--font-syne)' }}
              >
                {s}
              </span>
          ...
          <div className="sticky top-32 bg-green/5 border border-green/15 rounded-3xl p-7 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span
                  className={shippingFee === 0 ? 'text-green font-bold text-xs tracking-widest uppercase' : 'text-dark font-bold'}
                  style={{ fontFamily: 'var(--font-syne)' }}
                >
