...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Grabfabs', url: 'https://grabfabs.vercel.app' }],
  creator: 'Grabfabs',
  publisher: 'Grabfabs',
  robots: { index: true, follow: true, googleBot: { index: true, follow: true, 'max-image-preview': 'large', 'max-snippet': -1 } },
  alternates: { canonical: 'https://grabfabs.vercel.app' },
  openGraph: {
    type: 'website',
    locale: 'en_IN',
    siteName: 'Grabfabs',
    ...
    url: 'https://grabfabs.vercel.app',
    images: [{ url: 'https://grabfabs.vercel.app/og.jpg', width: 1200, height: 630, alt: 'Grabfabs – Feel Good, On the Go Foods' }],
  },
  twitter: {
